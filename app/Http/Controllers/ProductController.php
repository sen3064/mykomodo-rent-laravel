...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $cdn = $this->prod ? "https://cdn.pulo1000.com/v2/media_files" : "https://cdndev.pulo1000.com/v2/media_files";
    ...
    public function myProducts($category_id){
        ...
        foreach ($products as &$k) {
            ...
            $preurl = $this->prod ?  "https://cdn.pulo1000.com/storage/products/" : "https://cdndev.pulo1000.com/storage/products/";
            $banner = Media::find($k->image_id);
            if(explode('/',$banner->file_path)[0]=='0000'){
                $preurl = $this->prod ? "https://cdn.pulo1000.com/uploads/" : "https://cdndev.pulo1000.com/uploads/";
            }
            $k->banner = [
    ...
    public function search(Request $request)
    {
        ...
        $list = $product->where('status','publish')->with(['variants'=>function($q){
        ...
        foreach ($list as &$k) {
            ...
            $k->total_sales = OrderItem::where(['product_id'=>$k->id,'status'=>'Payment Sukses'])->whereNotNull('payment_id')->sum('quantity');
            $k->seller = User::where('id',$k->create_user)->first(['business_name as name','location','address']);
        }
    ...
    {
        $query = "SELECT a.create_user, b.business_name, concat(b.address,', ',b.city,', ',b.state,' ',b.zip_code) as address FROM bravo_market_products a, users b where a.category_id=7 and b.id=a.create_user ";
            ...
            if ($getLoc) {
                ...
                if ($loc) {
                    ...
                    if($setting && $setting->image_id){
                        ...
                        $k->banner = $this->prod ? "https://cdn.pulo1000.com/uploads/" . $banner : "https://cdndev.pulo1000.com/uploads/" . $banner;
                    }else{
                        $getBannerId = Product::where('create_user', $k->create_user)->first()->image_id;
                        $banner = Media::find($getBannerId)->file_resize_200;
                        $k->banner = $this->prod ? "https://cdn.pulo1000.com/storage/products/" . $banner : "https://cdndev.pulo1000.com/storage/products/" . $banner;
                    }
